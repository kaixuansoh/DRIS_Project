    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('CITIZEN', 'Citizen'), ('VOLUNTEER', 'Volunteer'), ('AUTHORITY', 'Authority')], default='CITIZEN', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('skills', models.CharField(choices=[('MEDICAL', 'Medical'), ('RESCUE', 'Rescue'), ('LOGISTICS', 'Logistics'), ('COUNSELING', 'Counseling'), ('TECHNICAL', 'Technical'), ('OTHER', 'Other')], default='OTHER', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('department', models.CharField(choices=[('POLICE', 'Police'), ('FIRE', 'Fire Department'), ('HEALTH', 'Health Department'), ('ADMIN', 'Administrative'), ('OTHER', 'Other')], default='OTHER', max_length=20)),
